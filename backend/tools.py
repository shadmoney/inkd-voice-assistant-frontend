...
class ContractData(BaseModel):
    ...
    fha_financing: Optional[bool] = Field(default=False, alias="FHA Financing")
    va_financing: Optional[bool] = Field(default=False, alias="VA Financing")
    conventional_financing: Optional[bool] = Field(default=False, alias="Conventional Financing")
    usda_financing: Optional[bool] = Field(default=False, alias="USDA Financing")
    other_financing: Optional[bool] = Field(default=False, alias="Other Financing")
